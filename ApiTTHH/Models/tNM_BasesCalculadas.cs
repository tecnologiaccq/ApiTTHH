...
namespace ApiTTHH.Models
{
    ...
    public partial class tNM_BasesCalculadas
    {
        ...
        public Nullable<decimal> ProvisionVacacionesDiasNormales { get; set; }
        public Nullable<decimal> ProvisionVacacionesDiasAdicionales { get; set; }
        public Nullable<decimal> tempFactorProvisionDiasNormales { get; set; }
        public Nullable<int> tempNumeroAniosEnEmpresa { get; set; }
        public Nullable<int> tempNumeroDiasAdicionales { get; set; }
        public Nullable<decimal> tempFactorProvisionDiasAdicionales { get; set; }
        public Nullable<decimal> tempAux_1 { get; set; }
        public Nullable<decimal> tempAux_2 { get; set; }
